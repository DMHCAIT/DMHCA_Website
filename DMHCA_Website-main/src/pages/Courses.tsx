...
const Courses = () => {
  ...
  const hardcodedCourses = [
    ...
    { id: 32, title: 'Fellowship In Interventional Radiology', image: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=600&fit=crop', lessons: 23, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 3, price: '₹2,50,000.00', category: 'Radiology', type: 'fellowship' },
    { id: 33, title: 'Fellowship In Interventional Cardiology', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 37, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 2, price: '₹2,80,000.00', category: 'Cardiology', type: 'fellowship' },
    { id: 34, title: 'Fellowship In Internal Medicine', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop', lessons: 84, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 6, price: '₹1,98,000.00', category: 'Medicine', type: 'fellowship' },
    { id: 35, title: 'Fellowship In Reproductive Medicine', image: 'https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?w=800&h=600&fit=crop', lessons: 77, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 1, price: '₹2,50,000.00', category: 'Reproductive', type: 'fellowship' },
    { id: 36, title: 'Fellowship In Pediatrics', image: 'https://images.unsplash.com/photo-1581594549595-35f6edc7b762?w=800&h=600&fit=crop', lessons: 33, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 5, price: '₹1,95,000.00', category: 'Pediatrics', type: 'fellowship' },
    { id: 37, title: 'Fellowship In Pediatric Echocardiography', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 30, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹1,80,000.00', category: 'Cardiology', type: 'fellowship' },
    { id: 38, title: 'Fellowship In Pain Management', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 33, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 3, price: '₹2,00,000.00', category: 'Medicine', type: 'fellowship' },
    { id: 39, title: 'Fellowship In Orthopedics', image: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&h=600&fit=crop', lessons: 31, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹1,70,000.00', category: 'Orthopedics', type: 'fellowship' },
    { id: 40, title: 'Fellowship In Minimal Access Surgery', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=800&h=600&fit=crop', lessons: 47, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹3,00,000.00', category: 'General Surgery', type: 'fellowship' },
    { id: 41, title: 'Fellowship In Emergency Medicine', image: 'https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=800&h=600&fit=crop', lessons: 79, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹1,74,000.00', category: 'Emergency', type: 'fellowship' },
    { id: 42, title: 'Fellowship In Dermatology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 78, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 2, price: '₹2,00,000.00', category: 'Dermatology', type: 'fellowship' },
    { id: 43, title: 'Fellowship In Critical Care', image: 'https://images.unsplash.com/photo-1519494140681-8b17d830a3e9?w=800&h=600&fit=crop', lessons: 74, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 6, price: '₹1,95,000.00', category: 'Emergency', type: 'fellowship' },
    { id: 44, title: 'Fellowship In Cosmetology And Aesthetic Medicine', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop', lessons: 75, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 3, price: '₹1,80,000.00', category: 'Dermatology', type: 'fellowship' },
    { id: 45, title: 'Fellowship In Cosmetic Gynecology', image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=800&h=600&fit=crop', lessons: 23, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 3, price: '₹2,50,000.00', category: 'Obs & Gynae', type: 'fellowship' },
    { id: 46, title: 'Fellowship In Clinical Cardiology', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 70, duration: '52 Week', level: 'Expert', rating: 5.0, reviews: 8, price: '₹2,40,000.00', category: 'Cardiology', type: 'fellowship' },
    { id: 47, title: 'Fellowship In Arthroscopy And Arthroplasty', image: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&h=600&fit=crop', lessons: 22, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 2, price: '₹2,10,000.00', category: 'Orthopedics', type: 'fellowship' },
    { id: 48, title: 'Fellowship In Obstetrics And Gynecology', image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=800&h=600&fit=crop', lessons: 68, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 3, price: '₹2,30,000.00', category: 'Obs & Gynae', type: 'fellowship' },
    { id: 49, title: 'Fellowship In Gynecologic Oncology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 64, duration: '50 Week', level: 'Expert', rating: 4.8, reviews: 4, price: '₹3,10,000.00', category: 'Oncology', type: 'fellowship' },
    { id: 50, title: 'Fellowship In GI Endoscopy', image: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=600&fit=crop', lessons: 12, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹1,80,000.00', category: 'Gastroenterology', type: 'fellowship' },
    { id: 51, title: 'Fellowship In Clinical Hematology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 56, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹2,60,000.00', category: 'Medicine', type: 'fellowship' },
    { id: 52, title: 'Fellowship In Clinical Embryology', image: 'https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?w=800&h=600&fit=crop', lessons: 27, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 1, price: '₹1,60,000.00', category: 'Reproductive', type: 'fellowship' },
    { id: 53, title: 'Fellowship In Cardiothoracic Surgery', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 18, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 2, price: '₹2,20,000.00', category: 'General Surgery', type: 'fellowship' },
    { id: 54, title: 'Fellowship In Cardio Oncology', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 17, duration: '50 Week', level: 'Expert', rating: 4.8, reviews: 4, price: '₹2,20,000.00', category: 'Cardiology', type: 'fellowship' },
    { id: 55, title: 'Fellowship In Gastroenterology', image: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&h=600&fit=crop', lessons: 46, duration: '50 Week', level: 'Expert', rating: 5.0, reviews: 4, price: '₹2,50,000.00', category: 'Gastroenterology', type: 'fellowship' },
    
    // PG Diploma (11) - From actual website data
    ...
    { id: 108, title: 'PG Diploma In Family Medicine', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop', lessons: 21, duration: '50 Week', level: 'Intermediate', rating: 5.0, reviews: 3, price: '₹1,72,000.00', category: 'Medicine', type: 'pg-diploma' },
    { id: 109, title: 'PG Diploma In Emergency Medicine', image: 'https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=800&h=600&fit=crop', lessons: 29, duration: '52 Week', level: 'Intermediate', rating: 5.0, reviews: 3, price: '₹1,72,000.00', category: 'Emergency', type: 'pg-diploma' },
    { id: 110, title: 'PG Diploma In Diabetology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 10, duration: '52 Week', level: 'Intermediate', rating: 4.6, reviews: 5, price: '₹1,79,000.00', category: 'Endocrinology', type: 'pg-diploma' },
    { id: 111, title: 'PG Diploma In Cosmetology And Aesthetic Medicine', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 20, duration: '50 Week', level: 'Intermediate', rating: 5.0, reviews: 0, price: '₹1,83,000.00', category: 'Dermatology', type: 'pg-diploma' },
    
    // Certificate (21) - From actual website data
    { id: 201, title: 'Certificate In Clinical Psychology', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop', lessons: 25, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 0, price: '₹40,000.00', category: 'Medicine', type: 'certificate' },
    { id: 202, title: 'Certificate In Obesity Management', image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=800&h=600&fit=crop', lessons: 50, duration: '24 Week', level: 'Beginner', rating: 5.0, reviews: 0, price: '₹35,000.00', category: 'Nutrition', type: 'certificate' },
    { id: 203, title: 'Certificate Course In HIV Medicine', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 42, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 0, price: '₹30,000.00', category: 'Medicine', type: 'certificate' },
    ...
    { id: 208, title: 'Certificate Course In Fetal Echocardiography', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 25, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 4, price: '₹60,000.00', category: 'Cardiology', type: 'certificate' },
    { id: 209, title: 'Certificate Course In Diabetology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 8, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 4, price: '₹50,000.00', category: 'Endocrinology', type: 'certificate' },
    { id: 210, title: 'Certificate Course In Cosmetology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 15, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 0, price: '₹50,000.00', category: 'Dermatology', type: 'certificate' },
    { id: 211, title: 'Certificate Course In Family Medicine', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&h=600&fit=crop', lessons: 36, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 5, price: '₹50,000.00', category: 'Medicine', type: 'certificate' },
    { id: 212, title: 'Certificate Course In Dermatology', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 12, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 4, price: '₹50,000.00', category: 'Dermatology', type: 'certificate' },
    { id: 213, title: 'Certificate Course In Neurology', image: 'https://images.unsplash.com/photo-1617791160536-598cf32026fb?w=800&h=600&fit=crop', lessons: 10, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 4, price: '₹50,000.00', category: 'Neurology', type: 'certificate' },
    { id: 214, title: 'Certificate Course In Obstetrics And Gynecology', image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=800&h=600&fit=crop', lessons: 22, duration: '12 Week', level: 'Beginner', rating: 5.0, reviews: 1, price: '₹30,000.00', category: 'Obs & Gynae', type: 'certificate' },
    { id: 215, title: 'Certificate Course In Pain Management', image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop', lessons: 26, duration: '18 Week', level: 'Beginner', rating: 5.0, reviews: 2, price: '₹35,000.00', category: 'Medicine', type: 'certificate' },
    { id: 216, title: 'Certificate Course In Orthopaedics', image: 'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=800&h=600&fit=crop', lessons: 15, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 1, price: '₹50,000.00', category: 'Orthopedics', type: 'certificate' },
    { id: 217, title: 'Certificate Course In Infertility', image: 'https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?w=800&h=600&fit=crop', lessons: 8, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 4, price: '₹50,000.00', category: 'Reproductive', type: 'certificate' },
    { id: 218, title: 'Certificate Course In Critical Care Medicine', image: 'https://images.unsplash.com/photo-1519494140681-8b17d830a3e9?w=800&h=600&fit=crop', lessons: 14, duration: '12 Week', level: 'Beginner', rating: 5.0, reviews: 0, price: '₹30,000.00', category: 'Emergency', type: 'certificate' },
    { id: 219, title: 'Certificate Course In Emergency Medicine', image: 'https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=800&h=600&fit=crop', lessons: 14, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 6, price: '₹50,000.00', category: 'Emergency', type: 'certificate' },
    { id: 220, title: 'Certificate Course In Clinical Cardiology', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 17, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 7, price: '₹50,000.00', category: 'Cardiology', type: 'certificate' },
    { id: 221, title: 'Certificate Course In Echocardiography', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&h=600&fit=crop', lessons: 19, duration: '25 Week', level: 'Beginner', rating: 5.0, reviews: 7, price: '₹50,000.00', category: 'Cardiology', type: 'certificate' },
  ]

  // Use Supabase data if available, otherwise use hardcoded courses
  const allCourses = dbCourses.length > 0 ? dbCourses.map(c => ({
    ...c,
    type: c.program_type
  })) : hardcodedCourses
