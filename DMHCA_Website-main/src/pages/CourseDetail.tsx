        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-semibold">Accreditation- International Board</span>
            </div>
            <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <div className="divide-y divide-gray-100">
                  <div className="flex items-center justify-between px-5 py-3">
                    ...
                    <span className="text-sm font-semibold text-gray-800">{(() => {
                      // Convert weeks to months (52 weeks = 12 months)
                      const match = /([0-9]+)\s*Week/i.exec(course.duration || '')
                      if (match) {
                  ...
                  <div className="flex items-center justify-between px-5 py-3">
                    ...
                    <span className="text-sm font-semibold text-gray-800">{course.curriculum?.length ?? 0}</span>
                  </div>
                  <div className="flex items-center justify-between px-5 py-3">
                    <div className="flex items-center gap-3 text-[#3D5A82]">
              ...
              <div className="bg-white rounded-lg p-4 shadow-lg text-center border border-gray-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-gray-600">15000+ Students</div>
                  </div>
                </div>
                <div className="flex items-center justify-center gap-3 pt-3 border-t border-gray-200">
                  ...
                  <div className="text-center">
                    <div className="font-bold text-gray-800 text-sm">Accreditation- International Board</div>
