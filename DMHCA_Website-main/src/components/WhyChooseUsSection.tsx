...
const WhyChooseUsSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Recognized programs, globally accredited certifications, and fellowship programs from universities and international accrediting bodies."
    },
    {
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 sm:p-8 md:p-12 text-white">
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
            <div className=" border-jhu-gold pl-4">
              <div className="font-sora text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2 text-jhu-gold">10,000+</div>
